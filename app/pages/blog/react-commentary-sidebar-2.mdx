...
export const image = { path: "/images/commentary-sidebar.gif", width: 600, height: 478, type: "image/gif" };
export const video = { path: "/videos/commentary-sidebar.mp4", width: 1120, height: 892, type: "video/mp4" };
export const date = "2019-10-30";

...
export const image = { path: "/images/multi-dimensional-space.png", width: 1556, height: 1018, type: "image/png" };
export const video = { path: "/videos/sum-of-squares-optimisation.mp4", width: 1218, height: 700, type: "video/mp4" };

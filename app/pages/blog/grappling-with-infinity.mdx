...
<Meta name="keywords" content="Chris Patuzzo,Constraint programming,Constraint solvers,Sentient,Infinity,Approximations,SAT,Satisfiability,NP-hard,Turinglcompleteness,Loop unrolling" />

<Meta.Image path="/images/multi-dimensional-space.png" width={1556} height={1018} type="png" />
<Meta.Video path="/videos/sum-of-squares-optimisation.mp4" width={1218} height={700} type="mp4" />
...
<time dateTime="2019-10-17">Published November 17, 2019 by {" "}

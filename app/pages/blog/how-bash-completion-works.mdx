...
export const image = { path: "/images/fizzbuzz-completion.gif", width: 800, height: 630, type: "image/gif" };
export const video = { path: "/videos/fizzbuzz-completion.mp4", width: 820, height: 646, type: "video/mp4" };
export const date = "2019-10-06";

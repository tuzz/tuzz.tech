...
export const image = { path: "/images/zz-completion.gif", width: 1012, height: 480, type: "gif" };
export const video = { path: "/videos/zz-completion.mp4", width: 1362, height: 646, type: "mp4" };

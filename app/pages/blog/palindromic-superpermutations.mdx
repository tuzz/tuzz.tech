...
export const image = { path: "/images/chaffin-search.gif", width: 800, height: 435, type: "gif" };
export const video = { path: "/videos/chaffin-search.mp4", width: 1280, height: 696, type: "mp4" };

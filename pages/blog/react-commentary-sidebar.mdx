...
<Head>
  ...
  <ImageMeta path="/images/commentary-sidebar.gif" width={600}  height={478} type="gif" />
  <VideoMeta path="/videos/commentary-sidebar.mp4" width={1120} height={892} type="mp4" />
</Head>
...
<Figure.Video src="/videos/commentary-sidebar.mp4">
The sidebar is responsive and becomes inline content on smaller screens
</Figure.Video>

<Aside target={r} moveDown={130}>

This is taken from my recent article on [How bash completion
works](/blog/how-bash-completion-works). I do like a gif within a gif.
...
<Figure.Video src="/videos/commentary-realignment.mp4">
...
<pre><code className="language-jsx">
  {readFile("pages/blog/react-commentary-sidebar.mdx", "fourth-wall-2")}
</code></pre>
...
<pre><code className="language-jsx">
  {readFile("pages/blog/react-commentary-sidebar.mdx", "fourth-wall-3")}
</code></pre>
...
<Aside target={r}><p>
Or comments about commenting on comments.
</p></Aside>
...
- We'll despairingly try to get print layouts working

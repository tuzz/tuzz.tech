...
commands and options. The idea being, if I type complete to `zz provision` and
if I type `zz <TAB><TAB>`, it should provide a friendly reminder of all
available commands.

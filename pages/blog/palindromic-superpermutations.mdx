...
<div className="note">
This is the first of two parts. The second will be available in a week or so.
</div>

<Figure.Video src="/videos/chaffin-search.mp4">
...
in a week or so. I’ll also announce its publication

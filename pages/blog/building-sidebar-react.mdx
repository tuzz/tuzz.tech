...
<pre><code className="language-jsx">
  {readFile("pages/blog/react-comments-sidebar.mdx", "fourth-wall-1")}
</code></pre>
</p></Aside>
...
<Figure>
<pre><code className="language-jsx">
  {readFile("pages/blog/react-comments-sidebar.mdx", "fourth-wall-2")}
</code></pre>
...
<pre><code className="language-jsx">
  {readFile("pages/blog/react-comments-sidebar.mdx", "fourth-wall-3")}
</code></pre>
